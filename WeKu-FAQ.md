...
### 区块链生成多少新代币？(TODO: does this need change?)
...
**WEKU Power** - WEKU Power（简称SP）是衡量用户对WEKU网络的影响程度。用户拥有的WEKU权力越多，他们可以影响帖子和评论的能力越大。 WEKU流动性比较小。如果用户希望“减少SP，他们将在13周内每周获得WEKU的平均分配。
